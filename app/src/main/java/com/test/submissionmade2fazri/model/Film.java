...
import static com.test.submissionmade2fazri.db.FavoriteFilmDatabaseContract.getColumnDouble;
import static com.test.submissionmade2fazri.db.FavoriteFilmDatabaseContract.getColumnInt;
import static com.test.submissionmade2fazri.db.FavoriteFilmDatabaseContract.getColumnString;
...
public class Film implements Parcelable {
    ...
    public Film(Cursor cursor){
        this.filmId = getColumnInt(cursor, ID);
        this.popularity = getColumnDouble(cursor, POPULAR);
        this.title = getColumnString(cursor, TITLE);
        this.language = getColumnString(cursor, LANGUANGE);
        this.overview = getColumnString(cursor, DETAIL);
        this.date = getColumnString(cursor, DATE);
        this.photo = getColumnString(cursor, IMAGE);
